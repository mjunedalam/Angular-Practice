...
describe('WellNameChipsComponent', () => {
  ...
  let mockStore: {
    ...
    pagedWellNames: ReturnType<typeof signal<any[]>>;
  ...
  it('should call selectWell when a chip is clicked', () => {
    ...
    expect(mockStore.selectWell).toHaveBeenCalledWith(2);
  });
  ...
  it('should show loading bar when store is loading', () => {
    ...
    fixture.detectChanges();
    const compiled = fixture.nativeElement as HTMLElement;
    const loadingBar = compiled.querySelector('.well-loading-bar--active');
